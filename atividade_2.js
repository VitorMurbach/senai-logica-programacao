...
let data_atual = [10, 10, 2021] //os campos da lista seguem a ordem: dia/mês/ano.
...
if (data_atual[2] < ano_evento){
    ...
    console.log('Cadastro não permitido! Data inválida')
//Nessa primeira parte será analisada a data do cadastro em relação com a data do evento.
} else if (idade_participante < 18){
    console.log('Cadastro não permitido! Idade insuficiente')
//Nessa segunda parte será analisada a idade do participante com a idade mínima do evento.
} else{
